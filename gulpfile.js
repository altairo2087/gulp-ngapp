...
(function() {
  'use strict';
  var DIST_PATH, ENV, ENV_CURRENT, Html, IMAGES, Inject, OPEN_BROWSER, ORDER_VENDOR_CSS, ORDER_VENDOR_JS, PORT, PUBLIC_PATH, Q, SERVER_WATCH, bower, browserSync, build, clean, coffee, css, filter, gulp, images, js, opts, plugins, ref, sass, server, task, tasks,
