...
(function() {
  'use strict';
  var Css, DIST_PATH, ENV, ENV_CURRENT, Html, IMAGES, Inject, OPEN_BROWSER, ORDER_VENDOR_CSS, ORDER_VENDOR_JS, PORT, PUBLIC_PATH, Q, SERVER_WATCH, bower, browserSync, build, clean, coffee, filter, gulp, images, js, opts, plugins, ref, server, task, tasks,
  ...
  build = function() {
    return clean().then(function() {
      return Q.all([bower(), Css.compile(), coffee(), js(), images()]).then(function() {
        return Html.compile();
      });
    });
  };
