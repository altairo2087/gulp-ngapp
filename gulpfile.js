...
(function() {
  'use strict';
  var DIST_PATH, ENV_CURRENT, ENV_DEV, ENV_PROD, IMAGES, ORDER_VENDOR_CSS, ORDER_VENDOR_JS, PORT, PUBLIC_PATH, Q, bower, build, clean, coffee, css, filter, gulp, html, images, inject, jade, js, log, opts, orderedCss, orderedCustomJs, orderedVendorJs, plugins, ref, sass, server, task, tasks;
