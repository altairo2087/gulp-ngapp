...
(function() {
  'use strict';
  var Css, DIST_PATH, ENV, ENV_CURRENT, Html, IMAGES, Inject, Js, OPEN_BROWSER, ORDER_VENDOR_CSS, ORDER_VENDOR_JS, PORT, PUBLIC_PATH, Q, SERVER_WATCH, bower, browserSync, build, clean, filter, gulp, images, opts, plugins, ref, server, task, tasks,
  ...
  build = function() {
    return clean().then(function() {
      return Q.all([bower(), Css.compile(), Js.compile(), images()]).then(function() {
        return Html.compile();
      });
    });
  };
